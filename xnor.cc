...
std::array<d_type, len> func(const std::array<d_type, len> s, const bool _x, const bool _y) {
    ...
    const std::array<d_type, len> s8 = {
        (s7[E_inv[0]] & x) | (s7[I[0]] & ~x),
        (s7[E_inv[1]] & x) | (s7[I[1]] & ~x),
        (s7[E_inv[2]] & x) | (s7[I[2]] & ~x),
        (s7[E_inv[3]] & x) | (s7[I[3]] & ~x),
        (s7[E_inv[4]] & x) | (s7[I[4]] & ~x)
    };

    const std::array<d_type, len> s9 = {
        (s8[D_inv[0]] & y) | (s8[I[0]] & ~y),
        (s8[D_inv[1]] & y) | (s8[I[1]] & ~y),
        (s8[D_inv[2]] & y) | (s8[I[2]] & ~y),
        (s8[D_inv[3]] & y) | (s8[I[3]] & ~y),
        (s8[D_inv[4]] & y) | (s8[I[4]] & ~y)
    };
    ...
    const std::array<d_type, len> s18 = {
        (s17[D_inv[0]] & x) | (s17[I[0]] & ~x),
        (s17[D_inv[1]] & x) | (s17[I[1]] & ~x),
        (s17[D_inv[2]] & x) | (s17[I[2]] & ~x),
        (s17[D_inv[3]] & x) | (s17[I[3]] & ~x),
        (s17[D_inv[4]] & x) | (s17[I[4]] & ~x)
    };

    const std::array<d_type, len> s19 = {
        (s18[E_inv[0]] & y) | (s18[I[0]] & ~y),
        (s18[E_inv[1]] & y) | (s18[I[1]] & ~y),
        (s18[E_inv[2]] & y) | (s18[I[2]] & ~y),
        (s18[E_inv[3]] & y) | (s18[I[3]] & ~y),
        (s18[E_inv[4]] & y) | (s18[I[4]] & ~y)
    };
